...
object Key {
    ...
    const val expiredTime = "expired_time"
    const val netAddress = "net_address_47"
    const val curLine = "current_line"
    const val lineFree = "line_fress"
    const val accountBean = "account_bean"
}
