...
package com.github.banananet.database
...
import com.github.banananet.utils.asIterable
import com.github.banananet.utils.parsePort
...
class Profile : Serializable {
    companion object {
        ...
        private val pattern = "(?i)ss://^[A-Za-z\\d+/]{214}([A-Za-z\\d+/][A-Za-z\\d+/=]|==)\$".toRegex()
...
//                    val match = legacyPattern.matchEntire(uri.host)
                    if (match != null) {
                        val profile = Profile()
    ...
    var id: Long = 0
    var name: String? = "Orange智能高速线路"
    var host: String = "198.199.101.152"
    var remotePort: Int = 8388
    var password: String = "banana"
